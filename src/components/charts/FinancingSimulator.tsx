          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              {Object.entries(estrategias).map(([key, estrategia]) => (
                <tr key={key} className={estrategia.economia === 0 ? 'bg-green-50' : ''}>
                  ...
                  <td className="py-2 px-3 text-center font-medium">
                    {formatCurrency(estrategia.totalPago)}
                  </td>
                  <td className="py-2 px-3 text-center font-medium">
                    {formatCurrency(estrategia.custoTotal)}
                  </td>
                  <td className="py-2 px-3 text-center">
                    {estrategia.economia === 0 ? (
                      <span className="text-green-600 font-medium">Melhor opção</span>
                    ) : (
